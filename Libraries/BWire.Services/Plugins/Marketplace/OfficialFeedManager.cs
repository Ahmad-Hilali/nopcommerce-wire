...
namespace BWire.Services.Plugins.Marketplace
{
    /// <summary>
    /// Represents the official feed manager (plugins from b-Wire marketplace)
    /// </summary>
    public partial class OfficialFeedManager
    {
        ...
        public virtual IList<OfficialFeedCategory> GetCategories()
        {
            ...
            {
                _logger.Error("No access to the list of plugins. Website www.b-Wire.com is not available.", ex);
            }
