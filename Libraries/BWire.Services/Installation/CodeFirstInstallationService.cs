...
using BWire.Core.Security;
using BWire.Data;
using BWire.Services.Blogs;
...
using BWire.Services.News;
using BWire.Services.Seo;

namespace BWire.Services.Installation
{
    /// <summary>
    ...
    public partial class CodeFirstInstallationService : IInstallationService
    {
        ...
        {
            //duplicate of ValidateSeName method of \BWire.Services\Seo\UrlRecordService.cs (we cannot inject it here)
            if (entity == null)
        ...
        protected virtual void InstallSampleCustomers()
        {
            ...
            //second user
            var secondUserEmail = "steve_gates@b-Wire.com";
            ...
            //third user
            var thirdUserEmail = "arthur_holmes@b-Wire.com";
            ...
            //fourth user
            var fourthUserEmail = "james_pan@b-Wire.com";
            ...
            //fifth user
            var fifthUserEmail = "brenda_lindgren@b-Wire.com";
            ...
            //sixth user
            var sixthUserEmail = "victoria_victoria@b-Wire.com";
        ...
        protected virtual void InstallOrders()
        {
            ...
            //first order
            var firstCustomer = _customerRepository.Table.First(c => c.Email == "steve_gates@b-Wire.com");
            ...
            var firstOrderItem3 = new OrderItem
            {
                ...
                PriceExclTax = 25M,
                OriginalProductCost = decimal.Zero,
                AttributeDescription = "From: Steve Gates &lt;steve_gates@b-Wire.com&gt;<br />For: Brenda Lindgren &lt;brenda_lindgren@b-Wire.com&gt;",
                AttributesXml = "<Attributes><GiftCardInfo><RecipientName>Brenda Lindgren</RecipientName><RecipientEmail>brenda_lindgren@b-Wire.com</RecipientEmail><SenderName>Steve Gates</SenderName><SenderEmail>steve_gates@gmail.com</SenderEmail><Message></Message></GiftCardInfo></Attributes>",
                Quantity = 1,
                DiscountAmountInclTax = decimal.Zero,
                DiscountAmountExclTax = decimal.Zero,
                DownloadCount = 0,
            ...
            var firstOrderGiftcard = new GiftCard
            {
                ...
                RecipientEmail = "brenda_lindgren@b-Wire.com",
                SenderName = "Steve Gates",
                SenderEmail = "steve_gates@b-Wire.com",
            ...
            //second order
            var secondCustomer = _customerRepository.Table.First(c => c.Email == "arthur_holmes@b-Wire.com");
            ...
            //third order
            var thirdCustomer = _customerRepository.Table.First(c => c.Email == "james_pan@b-Wire.com");
            ...
            //fourth order
            var fourthCustomer = _customerRepository.Table.First(c => c.Email == "brenda_lindgren@b-Wire.com");
            ...
            //fifth order
            var fifthCustomer = _customerRepository.Table.First(c => c.Email == "victoria_victoria@b-Wire.com");
        ...
        protected virtual void InstallSettings()
        {
            ...
            settingService.SaveSetting(new CommonSettings
            {
                ...
                SupportPreviousBWireVersions = true,
            ...
            settingService.SaveSetting(new StoreInformationSettings
            {
                ...
                FacebookLink = "https://www.facebook.com/b-Wire",
                TwitterLink = "https://twitter.com/b-Wire",
                YoutubeLink = "https://www.youtube.com/user/b-Wire",
                HidePoweredByBWire = false
            });
        ...
        protected virtual void InstallNews(string defaultUserEmail)
        {
            ...
            var news = new List<NewsItem>
            {
                new NewsItem
                {
                    ...
                    LanguageId = defaultLanguage.Id,
                    Title = "About b-Wire",
                    Short = "It's stable and highly usable. From downloads to documentation, www.b-Wire.com offers a comprehensive base of information, resources, and support to the b-Wire community.",
                    Full = "<p>For full feature list go to <a href=\"https://www.b-Wire.com\">b-Wire.com</a></p><p>Providing outstanding custom search engine optimization, web development services and e-commerce development solutions to our clients at a fair price in a professional manner.</p>",
                    Published = true,
                    CreatedOnUtc = DateTime.UtcNow
                },
                new NewsItem
                {
                    AllowComments = true,
                    LanguageId = defaultLanguage.Id,
                    Title = "b-Wire new release!",
                    Short = "b-Wire includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included! b-Wire is a fully customizable shopping cart",
                    Full = "<p>b-Wire includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included!</p>",
                    Published = true,
                    CreatedOnUtc = DateTime.UtcNow.AddSeconds(1)
                },
                new NewsItem
                {
                    ...
                    Short = "The new b-Wire store is open now! We are very excited to offer our new range of products. We will be constantly adding to our range so please register on our site.",
        ...
        protected virtual void InstallScheduleTasks()
        {
            var tasks = new List<ScheduleTask>
            {
                new ScheduleTask
                {
                    Name = "Send emails",
                    Seconds = 60,
                    Type = "BWire.Services.Messages.QueuedMessagesSendTask, BWire.Services",
                    Enabled = true,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    Name = "Keep alive",
                    Seconds = 300,
                    Type = "BWire.Services.Common.KeepAliveTask, BWire.Services",
                    Enabled = true,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    Name = "Delete guests",
                    Seconds = 600,
                    Type = "BWire.Services.Customers.DeleteGuestsTask, BWire.Services",
                    Enabled = true,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    Name = "Clear cache",
                    Seconds = 600,
                    Type = "BWire.Services.Caching.ClearCacheTask, BWire.Services",
                    Enabled = false,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    ...
                    //60 minutes
                    Seconds = 3600,
                    Type = "BWire.Services.Logging.ClearLogTask, BWire.Services",
                    Enabled = false,
                    StopOnError = false
                },
                new ScheduleTask
                {
                    ...
                    //60 minutes
                    Seconds = 3600,
                    Type = "BWire.Services.Directory.UpdateExchangeRateTask, BWire.Services",
                    Enabled = true,
                    StopOnError = false
                }
            };
