...
namespace BWire.Services.Common
{
    /// <summary>
    ...
    public static partial class NopCommonDefaults
    {
        ...
        #region b-Wire official site

        /// <summary>
        /// Gets a path to request the b-Wire official site for copyright warning
        /// </summary>
        /// <remarks>
        /// {0} : store URL
        ...
        /// <summary>
        /// Gets a path to request the b-Wire official site for news RSS
        /// </summary>
        /// <remarks>
        /// {0} : b-Wire version
        /// {1} : whether the store based is on the localhost
        ...
        /// {4} : language code
        /// </remarks>
        public static string NopNewsRssPath => "b-Wire-news-rss?version={0}&localhost={1}&hideAdvertisements={2}&storeUrl={3}&language={4}";

        /// <summary>
        /// Gets a path to request the b-Wire official site to notify about successful installation
        /// </summary>
        /// <remarks>
        /// {0} : b-Wire version
        /// {1} : whether the store based is on the localhost
        ...
        /// <summary>
        /// Gets a path to request the b-Wire official site for available categories of marketplace extensions
        /// </summary>
        /// <remarks>
        /// {0} : language code
        /// </remarks>
        ...
        /// <summary>
        /// Gets a path to request the b-Wire official site for available versions of marketplace extensions
        /// </summary>
        /// <remarks>
        /// {0} : language code
        /// </remarks>
        ...
        /// <summary>
        /// Gets a path to request the b-Wire official site for marketplace extensions
        /// </summary>
        /// <remarks>
