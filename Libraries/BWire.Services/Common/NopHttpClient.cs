...
using BWire.Core.Rss;
using BWire.Services.Localization;

namespace BWire.Services.Common
{
    /// <summary>
    /// Represents the HTTP client to request b-Wire official site
    /// </summary>
    public partial class NopHttpClient
    {
        ...
        {
            //configure client
            client.BaseAddress = new Uri("https://www.b-Wire.com/");
            client.Timeout = TimeSpan.FromSeconds(5);
            client.DefaultRequestHeaders.Add(HeaderNames.UserAgent, $"b-Wire-{NopVersion.CurrentVersion}");
