...
namespace BWire.Core.Domain
{
    ...
    {
        /// <summary>
        /// Gets or sets a value indicating whether "powered by b-Wire" text should be displayed.
        /// Please find more info at https://www.b-Wire.com/b-Wire-copyright-removal-key
        /// </summary>
        public bool HidePoweredByBWire { get; set; }
