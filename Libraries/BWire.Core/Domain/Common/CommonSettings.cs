...
namespace BWire.Core.Domain.Common
{
    ...
    public class CommonSettings : ISettings
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether we should support previous b-Wire versions (it can slightly improve performance)
        /// </summary>
        public bool SupportPreviousBWireVersions { get; set; }
