...
using BWire.Core.Html.CodeFormatter;
using BWire.Core.Infrastructure;

namespace BWire.Core.Html
{
    /// <summary>
    ...
    public partial class BBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote, bool replaceImg)
        {
            ...
            if (replaceUrl)
            {
                ...
                // format the URL tags: [url=https://www.b-Wire.com]my site[/url]
                // becomes: <a href="https://www.b-Wire.com">my site</a>
                text = regexUrl1.Replace(text, $"<a href=\"$1\" rel=\"nofollow\"{(newWindow ? " target=_blank" : "")}>$2</a>");

                // format the URL tags: [url]https://www.b-Wire.com[/url]
                // becomes: <a href="https://www.b-Wire.com">https://www.b-Wire.com</a>
            ...
            if (replaceImg)
            {
                // format the img tags: [img]https://www.b-Wire.com/Content/Images/Image.jpg[/img]
                // becomes: <img src="https://www.b-Wire.com/Content/Images/Image.jpg">
