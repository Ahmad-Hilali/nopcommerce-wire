...
namespace BWire.Web.Framework.Components
{
    /// <summary>
    /// Base class for ViewComponent in b-Wire
    /// </summary>
    public abstract class NopViewComponent : ViewComponent
    {
        private void PublishModelPrepared<TModel>(TModel model)
        {
            ...
            //as we do in the /BWire.Web.Framework/Mvc/Filters/PublishModelEventsAttribute.cs for controllers
