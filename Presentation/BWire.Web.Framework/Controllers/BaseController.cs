...
namespace BWire.Web.Framework.Controllers
{
    /// <summary>
    /// Base controller
    /// </summary>
    ...
    public abstract class BaseController : Controller
    {
        ...
        public virtual void SaveSelectedPanelName(string tabName, bool persistForTheNextRequest = true)
        {
            ...
            //"GetSelectedPanelName" method of \BWire.Web.Framework\Extensions\HtmlExtensions.cs
        ...
        {
            //keep this method synchronized with
            //"GetSelectedTabName" method of \BWire.Web.Framework\Extensions\HtmlExtensions.cs
            if (string.IsNullOrEmpty(tabName))
            {
