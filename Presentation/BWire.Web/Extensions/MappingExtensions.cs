...
namespace BWire.Web.Extensions
{
    public static class MappingExtensions
    {
        ...
        public static Address ToEntity(this BillingAddressMobModel model, bool trimFields = true)
        {
            if (model == null)
                return null;
        ...
        public static Address ToEntity(this BillingAddressMobModel model, Address destination, bool trimFields = true)
        {
            if (model == null)
                return destination;
