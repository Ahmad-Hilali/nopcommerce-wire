...
namespace BWire.Web.Factories.Mobile
{
     ...
     /// </summary>
    public partial interface IProductModelMobFactory
    {
        /// <summary>
        ...
        IEnumerable<ProductOverviewMobModel> PrepareProductOverviewModels(IEnumerable<Product> products,
        ...
        ProductDetailsMobModel PrepareProductDetailsModel(Product product, ShoppingCartItem updatecartitem = null, bool isAssociatedProduct = false);
        ...
        ProductReviewsMobModel PrepareProductReviewsModel(ProductReviewsMobModel model, Product product);
        ...
        CustomerProductReviewsMobModel PrepareCustomerProductReviewsModel(int? page);
