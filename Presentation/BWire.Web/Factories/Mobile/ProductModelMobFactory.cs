...
using BWire.Services.Shipping.Date;
using BWire.Services.Tax;
using BWire.Services.Vendors;
...
{
    public partial class ProductModelMobFactory : IProductModelMobFactory
    {
        #region Fields
        ...
        public ProductModelMobFactory(CaptchaSettings captchaSettings,
        ...
        protected virtual ProductReviewOverviewMobModel PrepareProductReviewOverviewModel(Product product)
        {
            ProductReviewOverviewMobModel productReview;
            ...
            if (_catalogSettings.ShowProductReviewsPerStore)
            {
                ...
                productReview = _staticCacheManager.Get(cacheKey, () =>
                {
                    ...
                    return new ProductReviewOverviewMobModel
                    {
            ...
            {
                productReview = new ProductReviewOverviewMobModel
                {
        ...
        protected virtual ProductOverviewMobModel.ProductPriceModel PrepareProductOverviewPriceModel(Product product, bool forceRedirectionAfterAddingToCart = false)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));

            var priceModel = new ProductOverviewMobModel.ProductPriceModel
            {
        ...
        protected virtual void PrepareSimpleProductOverviewPriceModel(Product product, ProductOverviewMobModel.ProductPriceModel priceModel)
        {
            //add to cart button
        ...
        protected virtual void PrepareGroupedProductOverviewPriceModel(Product product, ProductOverviewMobModel.ProductPriceModel priceModel)
        {
        ...
        protected virtual PictureMobModel PrepareProductOverviewPictureModel(Product product, int? productThumbPictureSize = null)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
        ...
        protected virtual ProductDetailsMobModel.ProductBreadcrumbMobModel PrepareProductBreadcrumbModel(Product product)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));

            var breadcrumbModel = new ProductDetailsMobModel.ProductBreadcrumbMobModel
            {
            ...
            {
                breadcrumbModel.CategoryBreadcrumb.Add(new CategorySimpleMobModel
                {
                    Id = catBr.Id,
        ...
        protected virtual IList<ProductTagMobModel> PrepareProductTagModels(Product product)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
            ...
            var model =
                _productTagService.GetAllProductTagsByProductId(product.Id)
                    ...
                    .Select(x => new ProductTagMobModel
                    {
                        Id = x.Id,
        ...
        protected virtual ProductDetailsMobModel.ProductPriceMobModel PrepareProductPriceModel(Product product)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));

            var model = new ProductDetailsMobModel.ProductPriceMobModel
            {
                ProductId = product.Id
            };
        ...
        protected virtual ProductDetailsMobModel.AddToCartMobModel PrepareProductAddToCartModel(Product product, ShoppingCartItem updatecartitem)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));

            var model = new ProductDetailsMobModel.AddToCartMobModel
            {
                ProductId = product.Id
            };
        ...
        protected virtual IList<ProductDetailsMobModel.ProductAttributeMobModel> PrepareProductAttributeModels(Product product, ShoppingCartItem updatecartitem)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));

            var model = new List<ProductDetailsMobModel.ProductAttributeMobModel>();
            ...
            foreach (var attribute in productAttributeMapping)
            {
                ...
                var attributeModel = new ProductDetailsMobModel.ProductAttributeMobModel
                {
                    Id = attribute.Id,
                    ProductId = product.Id,
                ...
                if (attribute.ShouldHaveValues())
                {
                    ...
                    {
                        var valueModel = new ProductDetailsMobModel.ProductAttributeValueMobModel
                        {
        ...
        protected virtual IList<ProductDetailsMobModel.TierPriceMobModel> PrepareProductTierPriceModels(Product product)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
            ...
            var model = _productService.GetTierPrices(product, _workContext.CurrentCustomer, _storeContext.CurrentStore.Id)
                   .Select(tierPrice =>
                   {
                       ...
                       return new ProductDetailsMobModel.TierPriceMobModel
                       {
        ...
        protected virtual IList<ManufacturerBriefInfoMobModel> PrepareProductManufacturerModels(Product product)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
        ...
        protected virtual PictureMobModel PrepareProductDetailsPictureModel(Product product, bool isAssociatedProduct, out IList<PictureMobModel> allPictureModels)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
            ...
            var cachedPictures = _staticCacheManager.Get(productPicturesCacheKey, () =>
            {
                ...
                var defaultPictureModel = new PictureMobModel
                {
                ...
                //all pictures
                var pictureModels = new List<PictureMobModel>();
        ...
        public virtual IEnumerable<ProductOverviewMobModel> PrepareProductOverviewModels(IEnumerable<Product> products,
            ...
            bool forceRedirectionAfterAddingToCart = false)
        {
            ...
            var models = new List<ProductOverviewMobModel>();
            foreach (var product in products)
            {
                var model = new ProductOverviewMobModel
                {
                    Id = product.Id,
        ...
        public virtual ProductDetailsMobModel PrepareProductDetailsModel(Product product,
            ShoppingCartItem updatecartitem = null, bool isAssociatedProduct = false)
        {
            ...
            //standard properties
            var model = new ProductDetailsMobModel
            {
                Id = product.Id,
                Name = _localizationService.GetLocalized(product, x => x.Name),
                ShortDescription = _localizationService.GetLocalized(product, x => x.ShortDescription),
            ...
            if (_vendorSettings.ShowVendorOnProductDetailsPage)
            {
                ...
                if (vendor != null && !vendor.Deleted && vendor.Active)
                {
                    ...
                    model.VendorModel = new VendorBriefInfoMobModel
                    {
                        Id = vendor.Id,
        ...
        public virtual ProductReviewsMobModel PrepareProductReviewsModel(ProductReviewsMobModel model, Product product)
        {
            if (model == null)
            ...
            {
                model.ReviewTypeList.Add(new ReviewTypeMobModel
                {
                    Id = reviewType.Id,
            ...
            foreach (var pr in productReviews)
            {
                ...
                var productReviewModel = new ProductReviewMobModel
                {
                    Id = pr.Id,
                    ...
                    Rating = pr.Rating,
                    Helpfulness = new ProductReviewHelpfulnessMobModel
                    {
                ...
                foreach (var q in _reviewTypeService.GetProductReviewReviewTypeMappingsByProductReviewId(pr.Id))
                {
                    ...
                    productReviewModel.AdditionalProductReviewList.Add(new ProductReviewReviewTypeMappingMobModel
                    {
            ...
            foreach (var rt in model.ReviewTypeList)
            {
                ...
                var reviewTypeMappingModel = new AddProductReviewReviewTypeMappingMobModel
                {
                    ReviewTypeId = rt.Id,
                    Name = _localizationService.GetLocalized(reviewType, entity => entity.Name),
                    Description = _localizationService.GetLocalized(reviewType, entity => entity.Description),
        ...
        public virtual CustomerProductReviewsMobModel PrepareCustomerProductReviewsModel(int? page)
        {
            ...
            var productReviews = new List<CustomerProductReviewMobModel>();

            foreach (var review in list)
            {
                var product = _productService.GetProductById(review.ProductId);

                var productReviewModel = new CustomerProductReviewMobModel
                {
                    Title = review.Title,
                    ProductId = product.Id,
            ...
            var pagerModel = new PagerModel
            {
                ...
                UseRouteLinks = true,
                RouteValues = new CustomerProductReviewsMobModel.CustomerProductReviewsRouteValues { pageNumber = pageIndex }
            };

            var model = new CustomerProductReviewsMobModel
            {
        ...
        public virtual ProductEmailAFriendMobModel PrepareProductEmailAFriendModel(ProductEmailAFriendMobModel model, Product product, bool excludeProperties)
        {
            if (model == null)
                throw new ArgumentNullException(nameof(model));
        ...
        public virtual IList<ProductSpecificationMobModel> PrepareProductSpecificationModel(Product product)
        {
            if (product == null)
                throw new ArgumentNullException(nameof(product));
            ...
            return _specificationAttributeService.GetProductSpecificationAttributes(product.Id, 0, null, true)
                .Select(psa =>
                {
                    ...
                    var m = new ProductSpecificationMobModel
                    {
