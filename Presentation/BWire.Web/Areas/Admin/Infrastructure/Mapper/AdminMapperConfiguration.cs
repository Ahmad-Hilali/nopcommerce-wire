...
using BWire.Web.Areas.Admin.Models.Affiliates;
using BWire.Web.Areas.Admin.Models.Blogs;
using BWire.Web.Areas.Admin.Models.Catalog;
using BWire.Web.Areas.Admin.Models.Cms;
...
using BWire.Web.Areas.Admin.Models.ExternalAuthentication;
using BWire.Web.Areas.Admin.Models.Forums;
using BWire.Web.Areas.Admin.Models.Localization;
using BWire.Web.Areas.Admin.Models.Logging;
...
using BWire.Web.Areas.Admin.Models.Payments;
...
namespace BWire.Web.Areas.Admin.Infrastructure.Mapper
{
    ...
    public class AdminMapperConfiguration : Profile, IOrderedMapperProfile
    {
        ...
        {
            CreateMap<BWire.Web.Models.Catalog.CategoryModel, CategoryMobModel>();
            CreateMap<BWire.Web.Models.Catalog.CategorySimpleModel, CategorySimpleMobModel>();
        }
        ...
        protected virtual void CreateCatalogMaps()
        {
            ...
            CreateMap<Category, CategorySimpleMobModel>();
