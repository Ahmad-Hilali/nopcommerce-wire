...
namespace BWire.Web.Areas.Admin.Factories
{
    ...
    public partial class HomeModelFactory : IHomeModelFactory
    {
        ...
        public virtual BWireNewsModel PrepareBWireNewsModel()
        {
            var model = new BWireNewsModel
            {
            ...
            try
            {
                ...
                for (var i = 0; i < rssData.Items.Count; i++)
                {
                    ...
                    var newsItem = new BWireNewsDetailsModel
                    {
            ...
            {
                _logger.Error("No access to the news. Website www.BWire.com is not available.", ex);
            }
