...
{
    public partial class PopularProductTagsMobModel : BaseNopModel
    {
        public PopularProductTagsMobModel()
        {
            Tags = new List<ProductTagMobModel>();
        }
        ...
        public virtual int GetFontSize(ProductTagMobModel productTag)
        {
        ...
        public List<ProductTagMobModel> Tags { get; set; }
