...
using BWire.Web.Framework.UI.Paging;
using System;
...
{
    public partial class CatalogPagingFilteringMobModel : BasePageableModel
    {
        #region Ctor
        ...
        /// Constructor
        /// </summary>
        public CatalogPagingFilteringMobModel()
        {
            AvailableSortOptions = new List<SelectListItem>();
            AvailableViewModes = new List<SelectListItem>();
            PageSizeOptions = new List<SelectListItem>();

            PriceRangeFilter = new PriceRangeFilterMobModel();
            SpecificationFilter = new SpecificationFilterMobModel();
        }
        ...
        /// </summary>
        public PriceRangeFilterMobModel PriceRangeFilter { get; set; }

        /// <summary>
        /// Specification filter model
        /// </summary>
        public SpecificationFilterMobModel SpecificationFilter { get; set; }
        ...
        /// Price range filter model
        /// </summary>
        public partial class PriceRangeFilterMobModel : BaseNopModel
        {
            #region Const
            ...
            /// Ctor
            /// </summary>
            public PriceRangeFilterMobModel()
            {
                Items = new List<PriceRangeFilterMobItem>();
            }
            ...
            public virtual void LoadPriceRangeFilters(string priceRangeStr, IWebHelper webHelper, IPriceFormatter priceFormatter)
            {
                ...
                if (priceRangeList.Any())
                {
                    ...
                    {
                        //from&to
                        var item = new PriceRangeFilterMobItem();
                        if (x.From.HasValue)
            ...
            /// Filter items
            /// </summary>
            public IList<PriceRangeFilterMobItem> Items { get; set; }
            /// <summary>
        ...
        /// </summary>
        public partial class PriceRangeFilterMobItem : BaseNopModel
        {
            /// <summary>
            /// From
            /// </summary>
        ...
        /// Specification filter model
        /// </summary>
        public partial class SpecificationFilterMobModel : BaseNopModel
        {
            #region Const
            ...
            /// Ctor
            /// </summary>
            public SpecificationFilterMobModel()
            {
                AlreadyFilteredItems = new List<SpecificationFilterMobItem>();
                NotFilteredItems = new List<SpecificationFilterMobItem>();
            }
                ...
                IWebHelper webHelper, IWorkContext workContext, IStaticCacheManager staticCacheManager)
            {
                ...
                AlreadyFilteredItems = alreadyFilteredOptions.Select(x =>
                    new SpecificationFilterMobItem
                    {
                ...
                NotFilteredItems = allFilters.Except(alreadyFilteredOptions).Select(x =>
                {
                    ...
                    return new SpecificationFilterMobItem()
                    {
                        SpecificationAttributeName = x.SpecificationAttributeName,
                        SpecificationAttributeOptionName = x.SpecificationAttributeOptionName,
                        SpecificationAttributeOptionColorRgb = x.SpecificationAttributeOptionColorRgb,
            ...
            /// </summary>
            public IList<SpecificationFilterMobItem> AlreadyFilteredItems { get; set; }
            /// <summary>
            /// Not filtered yet items
            /// </summary>
            public IList<SpecificationFilterMobItem> NotFilteredItems { get; set; }
            /// <summary>
            /// URL of "remove filters" button
            /// </summary>
            public string RemoveFilterUrl { get; set; }
        ...
        /// </summary>
        public partial class SpecificationFilterMobItem : BaseNopModel
        {
            /// <summary>
